...
export const schemaConnection = {
	...
	categories: { type: [ String ], enum: [ 'passthrough', 'hris', 'ats', 'auth', 'crm', 'enrich', 'martech', 'ticketing', 'uc', 'accounting', 'storage', 'commerce', 'payment', 'genai', 'messaging', 'kms', 'task', 'scim', 'lms', 'repo', 'metadata', 'calendar', 'verification' ], index: true }, // The Integration categories that this connection supports
...
export const schemaIntegrationSupport = {
	...
	list_end_le: { type: String, enum: [ 'supported-required', 'supported', 'not-supported' ] }, // @deprecated; use list_end_lt
	...
	list_expand_recurring_events: { type: String, enum: [ 'supported-required', 'supported', 'not-supported' ] }, // @deprecated; use list_expand
	...
	virtual_webhook_end_le: { type: String, enum: [ 'supported-required', 'supported', 'not-supported' ] }, // @deprecated; use virtual_webhook_end_lt
...
export const schemaWebhook = {
	...
	filters: { type: Object },
	db_type: { type: String, enum: [ 'mongodb', 'mysql', 'postgres', 'mssql', 'mariadb' ] },
	db_url: { type: String },
