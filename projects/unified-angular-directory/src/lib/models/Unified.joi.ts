...
export const joiApiCall = Joi.object({
	id: Joi.string().description('Unique identifier for this API call').meta( { readonly: true }).optional(),
	created_at: Joi.date().description('The date that this object was created').meta( { readonly: true }).optional(),
	...
	size: Joi.number().description('The size of the response').optional(),
...
export const joiConnection = Joi.object({
	id: Joi.string().description('Unique identifier for this integration object').meta( { readonly: true }).optional(),
	created_at: Joi.date().description('The date that this integration object was created').meta( { readonly: true }).optional(),
	updated_at: Joi.date().description('The last date that this integration object was updated').meta( { readonly: true }).optional(),
	workspace_id: Joi.string().meta( { readonly: true }).optional(),
	integration_type: Joi.string().allow('').description('The integration type').required(),
	...
	is_paused: Joi.boolean().description('Whether this integration has exceed the monthly limit of the plan').meta( { readonly: true }).optional(),
...
export const joiIntegrationSupport = Joi.object({
	methods: Joi.object().pattern(Joi.string(), Joi.boolean().optional()).optional(),
	inbound_fields: Joi.object().pattern(Joi.string(), joiSupportInboundType.optional()).optional(),
	outbound_fields: Joi.object().pattern(Joi.string(), joiSupportOutboundType.optional()).optional(),
	...
	list_teacher_id: joiSupportInboundType.optional(),
	list_repo_id: joiSupportInboundType.optional(),
	list_org_id: joiSupportInboundType.optional(),
	list_calendar_id: joiSupportInboundType.optional(),
	...
	list_event_id: joiSupportInboundType.optional(),
	list_start_gte: joiSupportInboundType.optional(),
	list_end_lt: joiSupportInboundType.optional(),
	list_end_le: joiSupportInboundType.description('@deprecated; use list_end_lt').optional(),
	...
	list_status: joiSupportInboundType.optional(),
	list_branch_id: joiSupportInboundType.optional(),
	list_pipeline_id: joiSupportInboundType.optional(),
	list_category_id: joiSupportInboundType.optional(),
	list_package_id: joiSupportInboundType.optional(),
	list_expand: joiSupportInboundType.optional(),
	list_expand_recurring_events: joiSupportInboundType.description('@deprecated; use list_expand').optional(),
	native_webhook_parent_id: joiSupportInboundType.optional(),
	native_webhook_project_id: joiSupportInboundType.optional(),
	native_webhook_company_id: joiSupportInboundType.optional(),
	native_webhook_task_id: joiSupportInboundType.optional(),
	native_webhook_channel_id: joiSupportInboundType.optional(),
	native_webhook_calendar_id: joiSupportInboundType.optional(),
	native_webhook_event_id: joiSupportInboundType.optional(),
	...
	virtual_webhook_status: joiSupportInboundType.optional(),
	virtual_webhook_start_gte: joiSupportInboundType.optional(),
	virtual_webhook_end_lt: joiSupportInboundType.optional(),
	virtual_webhook_end_le: joiSupportInboundType.description('@deprecated; use virtual_webhook_end_lt').optional(),
	virtual_webhook_task_id: joiSupportInboundType.optional(),
	virtual_webhook_space_id: joiSupportInboundType.optional(),
	virtual_webhook_repo_id: joiSupportInboundType.optional(),
	virtual_webhook_project_id: joiSupportInboundType.optional(),
	virtual_webhook_pipeline_id: joiSupportInboundType.optional(),
	virtual_webhook_page_id: joiSupportInboundType.optional(),
	virtual_webhook_org_id: joiSupportInboundType.optional(),
	virtual_webhook_location_id: joiSupportInboundType.optional(),
	virtual_webhook_list_id: joiSupportInboundType.optional(),
	virtual_webhook_job_id: joiSupportInboundType.optional(),
	virtual_webhook_item_id: joiSupportInboundType.optional(),
	virtual_webhook_fields: joiSupportInboundType.optional(),
	virtual_webhook_event_id: joiSupportInboundType.optional(),
	virtual_webhook_customer_id: joiSupportInboundType.optional(),
	virtual_webhook_collection_id: joiSupportInboundType.optional(),
	virtual_webhook_candidate_id: joiSupportInboundType.optional(),
	virtual_webhook_call_id: joiSupportInboundType.optional(),
	virtual_webhook_branch_id: joiSupportInboundType.optional(),
	virtual_webhook_application_id: joiSupportInboundType.optional(),
...
export const joiIntegration = Joi.object({
	...
	is_active: Joi.boolean().description('Is this integration active in this workspace').optional(),
	...
	in_progress: Joi.boolean().description('If this integration is not yet available as it is currently being built by unified.to').optional(),
	...
	beta: Joi.boolean().description('This integration is new and is still considered "beta"').optional(),
	support: Joi.object().pattern(Joi.string(), joiIntegrationSupport.optional()).optional(),
	tested_at: Joi.date().optional(),
	sandbox: Joi.any().optional(),
	partnership: Joi.any().optional(),
	saml: Joi.any().optional(),
...
export const joiIssue = Joi.object({
	...
	size: Joi.number().description('1-5, 1 is lowest').optional(),
	importance: Joi.number().description('1-5, 1 is lowest').optional(),
}).label('Issue');

export const joiNotification = Joi.object({
	id: Joi.string().description('Unique identifier for this notification object').meta( { readonly: true }).optional(),
	created_at: Joi.date().description('The date that this integration object was created').meta( { readonly: true }).optional(),
	workspace_id: Joi.string().meta( { readonly: true }).optional(),
...
export const joiPlan = Joi.object({
	...
	dedicated_channel: Joi.boolean().description('Dedicated Slack/Discord channel').optional(),
}).label('Plan');
...
export const joiWebhook = Joi.object({
	...
	interval: Joi.number().description('The interval (in minutes) to check for updated/new objets.  Minimum is 5 minutes.  Interval is based off of 5-minute increments.').optional(),
	...
	filters: Joi.object().pattern(Joi.string(), Joi.string().optional()).allow(null, '').optional(),
	db_type: joiWebhookDatabaseType.optional(),
...
export const joiWorkspace = Joi.object({
	...
	plan_term: joiPlanTerm.default('monthly').description('monthly or yearly').optional(),
	...
	saml_only_login: Joi.boolean().description('if true, only allow SAML login').optional(),
